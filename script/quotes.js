document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!sessionStorage.getItem("modalShown")) {
    const quotes = [
      ...
      {
        quote:
          "We always have a choice. We can make the world a better place or not.",
        author: "Bill Gates, Co-founder of Microsoft",
      },
      {
      ...
      {
        quote:
          "We are always in the process of creating ourselves, and we can change that process.",
        author: "Bill Gates, Co-founder of Microsoft",
      },
      ...
      // Quotes from Shiv Nadar (Founder of HCL Technologies)
      {
        ...
        author: "Shiv Nadar, Founder of HCL Technologies",
      },
      {
        quote:
          "Success is not about winning, it is about the journey and the struggle.",
        author: "Shiv Nadar, Founder of HCL Technologies",
      },
      {
        quote:
      ...
      {
        quote:
          "The only way to achieve greatness is to have the courage to follow your dreams.",
        author: "Shiv Nadar, Founder of HCL Technologies",
      },
      {
        quote:
      ...
      {
        quote:
          "Innovation is the key to progress. It is the willingness to experiment and learn that leads to success.",
        author: "Shiv Nadar, Founder of HCL Technologies",
      },
      {
        quote:
          "The power to shape your future lies in your hands. Embrace change and pursue excellence.",
        author: "Shiv Nadar, Founder of HCL Technologies",
      },
      {
        quote:
      ...
      {
        quote:
          "The road to success is not a straight path; it is full of twists and turns. Embrace each challenge as a step towards your goals.",
        author: "Shiv Nadar, Founder of HCL Technologies",
      },
      {
        quote:
      ...
      {
        quote: "The best way to predict the future is to create it.",
        author: "Narayana Murthy, Co-founder of Infosys",
      },
      {
      ...
      {
        quote:
          "One must keep trying, learning, and improving oneself until they reach their goal.",
        author: "Narayana Murthy, Co-founder of Infosys",
      },
      {
        quote:
          "In the long run, the most important thing is not what you do but how you do it.",
        author: "Narayana Murthy, Co-founder of Infosys",
      },
      {
        quote:
          "To succeed in business, you need to be passionate, be a good learner, and be willing to take risks.",
        author: "Narayana Murthy, Co-founder of Infosys",
      },
      {
        quote:
          "The biggest challenge is not the technology, but the human mind.",
        author: "Narayana Murthy, Co-founder of Infosys",
      },
      {
        quote: "Success comes to those who are not afraid to fail.",
        author: "Narayana Murthy, Co-founder of Infosys",
      },
      {
        quote:
      ...
      {
        quote:
          "Ethics and values are more important than technology or finance.",
        author: "Narayana Murthy, Co-founder of Infosys",
      },
      ...
      {
        quote:
          "A person who is trying to make a difference in the world should focus on making a difference to the lives of others.",
      ...
      {
        quote:
          "The internet is the greatest thing to have happened to humanity in the last 20 years.",
        author: "Sundar Pichai, CEO of Google",
      },
      {
        quote:
          "You should always focus on improving yourself and learning new things.",
        author: "Sundar Pichai, CEO of Google",
      },
      {
        quote: "Innovation comes from people who are not afraid to fail.",
        author: "Sundar Pichai, CEO of Google",
      },
      {
        quote:
      ...
      {
        quote:
          "Think big and be open to possibilities. Sometimes the best ideas come from the simplest thoughts.",
        author: "Sundar Pichai, CEO of Google",
      },
      {
        quote:
          "You should embrace change and see it as an opportunity rather than a challenge.",
        author: "Sundar Pichai, CEO of Google",
      },
      {
        quote: "The best way to predict the future is to invent it.",
      ...
      {
        quote: "Stay curious, stay open-minded, and continue to learn.",
        author: "Sundar Pichai, CEO of Google",
      },
      {
        quote:
          "Don’t be afraid to take risks and make mistakes; that’s how innovation happens.",
        author: "Sundar Pichai, CEO of Google",
      },
      {
        quote:
          "Focus on the impact you can make, not just on the accolades you receive.",
        author: "Sundar Pichai, CEO of Google",
      },
      {
        quote:
      ...
      // Quotes from Ratan Tata
      {
        ...
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
      {
        quote:
          "You should not be afraid of taking risks and making mistakes. They are part of the journey to success.",
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
      {
        quote:
          "I have always believed that if you don’t take risks, you cannot create a future.",
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
      {
        quote:
      ...
      {
        quote:
          "The greatest fear that you can have is to fear that you will not have enough.",
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
      {
        quote:
          "I think we should not be afraid of the future. It is a question of how we manage our fears and face the challenges.",
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
      {
        quote:
      ...
      {
        quote:
          "I believe in taking up challenges, in dealing with adversity, and in the power of human perseverance.",
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
      {
        quote:
      ...
      {
        quote:
          "True success is about creating something that impacts the world positively.",
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
      {
        quote:
          "The measure of a person’s success is how they deal with their failures.",
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
      {
        quote: "Always be humble, and have a passion for what you do.",
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
      {
        quote:
          "Success is not a destination; it is a journey of continuous improvement and learning.",
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
      {
        quote: "The best way to predict the future is to create it.",
      ...
      {
        quote:
          "It is important to have a vision and follow your passion, even if it means going against the grain.",
        author: "Ratan Tata, Chairman Emeritus of Tata Sons",
      },
    ];
